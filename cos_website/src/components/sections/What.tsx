      ...
      <div className="w-1/2 ">
        <div className=" m-10">
          ...
          <div className="text-cos-off-black  text-2xl pt-7">
            ...
            live music and amazing DJ's who will make you dance the night away, a fun challenge
  ...
  return (
    <div className="flex flex-col md:flex-row md:h-screen">
      ...
      <img
        src="/wallpapers/Martin02.JPG"
        alt="guy"
        className="w-1/2 object-cover md:block hidden"
        id="left_image"
      />
      ...
      <div className="w-full md:w-1/2">
        <div className="m-10">
          ...
          <div className="text-cos-off-black text-2xl pt-7">
            ...
            live music and amazing DJ's who will make you dance the night away, a fun challenge
            which will get you out of your comfort zone and relaxed moments at
            the campfires or on our cozy sofas.
          </div>
        </div>
        {/* Right Bottom Image (always visible) */}
        <img
