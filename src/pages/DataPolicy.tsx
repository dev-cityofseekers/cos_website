        ...
        <div className="bg-white bg-opacity-95 backdrop-blur-lg rounded-2xl shadow-xl p-8">
          ...
          <section className="space-y-8">
            ...
            <div className="bg-cos-main-orange bg-opacity-20 p-6 rounded-xl">
              ...
              <p className="text-cos-off-black">{t("privacy.intro.text")}</p>
            </div>
            ...
            <div className="bg-white shadow-lg rounded-xl p-6">
              ...
              <p className="text-cos-off-black mb-4">{t("privacy.collection.intro")}</p>
              <ul className="list-disc pl-8 space-y-2">
                <li className="text-cos-off-black">
                  <strong>{t("privacy.collection.contact.title")}</strong>:{" "}
                  {t("privacy.collection.contact.text")}
                </li>
                <li className="text-cos-off-black">
                  <strong>{t("privacy.collection.transaction.title")}</strong>:{" "}
                  {t("privacy.collection.transaction.text")}
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white shadow-lg rounded-xl p-6">
              ...
              <div className="space-y-4">
                ...
                <p className="text-cos-off-black">{t("privacy.maps.text2")}</p>
              </div>
            </div>
