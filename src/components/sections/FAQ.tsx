          ...
          <div>
            {[...Array(14)].map((_, index) => (
                <div key={index} className="mb-4 rounded-md select-none text-lg">
                  ...
                  >
               <span className="font-omnes">
                 {t(`faq.q${index + 1}.question`)}
               </span>
                      ...
                      <div className="p-4">
                        {index === 2 ? (
                            <Trans i18nKey={`faq.q${index + 1}.answer`}>
                              Yes, we have a Ruleset or Code of Conduct to clarify how we want to treat each other, find it <a href="/code" className="text-blue-500 underline">here</a> or under <a href="/code" className="text-blue-500 underline">cityofseekers.eu/code</a>.
                            </Trans>
                        ) : (
